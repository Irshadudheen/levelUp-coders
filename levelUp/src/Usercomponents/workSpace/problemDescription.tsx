...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem }) => {
    console.log(problem, 'data in description');
                ...
                <div className='px-5'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='mt-4'>
                            ...
                            {problem.examples && problem.examples.map((example, index) => (
                                <div key={example.id}>
									...
									{example.img && <img src={example.img}  className='mt-3'/>}
                        ...
                        <div className='my-5'>
                            ...
                            <ul className='text-white ml-5 list-disc' dangerouslySetInnerHTML={{ __html: problem.constraints }} />
                        </div>
                    </div>
                </div>
            </div>
