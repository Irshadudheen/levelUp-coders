          ...
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            <div className="mb-4">
              <input
                ...
                required
                className={`w-full p-3 bg-gray-50 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.name?.message ? 'border-red-500 focus:ring-red-500' : ''}`}
              />
            ...
            <div className="mb-4">
              <input
                ...
                placeholder="Email"
                required
                className={`w-full p-3 bg-gray-50 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email?.message ? 'border-red-500 focus:ring-red-500' : ''}`}
              />
            ...
            <div className="mb-4">
              <div className="relative">
                <input
                  ...
                  className={`w-full p-3 bg-gray-50 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.password?.message ? 'border-red-500 focus:ring-red-500' : ''}`}
                  placeholder="Enter password"
                />
                <button
                  type="button"
                  onClick={togglePasswordVisibility}
                  className="absolute inset-y-0 end-0 flex items-center z-20 px-3 cursor-pointer text-gray-500 rounded-e-md focus:outline-none focus:text-blue-600"
                >
                  <svg
            ...
            <div className="mb-4">
              <input
                ...
                required
                className={`w-full p-3 ${confirmError ? 'text-red-700 border-red-500 focus:ring-red-500' : ''} bg-gray-50 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
            </div>
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <a href="#" className="flex items-center justify-center w-1/2 py-2 bg-gray-50 hover:bg-gray-100 rounded text-gray-900 font-bold">
